      ...
      <main className="legal-page" id="main-content">
        <header className="legal-header">
          ...
          <p className="about-lede">
            Short version: use Campable in good faith and cancel Pro any time
            from the Stripe portal. Our availability data is best-effort. The
            booking site is authoritative when you actually reserve.
          </p>
        </header>
        ...
        <section className="legal-section" aria-labelledby="deal-heading">
          ...
          <p>
            ...
            providers, three simultaneous active watches with 15-minute
            polling, and shareable result links. It is genuinely free. We
            don&rsquo;t require a card to use it.
          </p>
          <p>
            ...
            trip-planner sessions per month, and anomaly-based deal alerts.
            See <Link to="/pricing">/pricing</Link> for the full comparison.
          </p>
        </section>
        ...
        <section className="legal-section" aria-labelledby="refund-heading">
          ...
          <p>
            ...
            but the current period isn&rsquo;t refunded.
          </p>
        </section>
        ...
        <section className="legal-section" aria-labelledby="use-heading">
          ...
          <p>
            Use Campable for personal trip planning, not commercial resale.
            Please don&rsquo;t scrape the site, automate bookings, create
            multiple accounts to dodge free-tier limits, or try to break
            authentication, billing, or notification systems.
          </p>
        </section>
        ...
        <section className="legal-section" aria-labelledby="termination-heading">
          ...
          <p>
            You can cancel Pro any time from the Stripe Customer Portal and
            delete your account from the user menu. We may suspend or
            terminate accounts that violate the acceptable-use rules, abuse
            the system, or chargeback Pro charges without first contacting
            us.
          </p>
        </section>
        ...
        <section className="legal-section" aria-labelledby="warranty-heading">
          ...
          <p>
            ...
            accurate at any given moment. Availability flips faster than our
            polling interval, and the underlying systems sometimes return
            stale data. Always confirm on the booking site before completing
            a reservation.
          </p>
          <p>
            Campable does not process bookings or take a cut of reservations.
            When you click &ldquo;Book,&rdquo; you go directly to the
            operator and pay them. We have no role in the reservation
        ...
        <section className="legal-section" aria-labelledby="liability-heading">
          ...
          <p>
            ...
            the fees you paid in the 12 months preceding the claim. The
            service is provided &ldquo;as is&rdquo; without warranty of
            merchantability or fitness for a particular purpose. This does
            not limit liability for things that can&rsquo;t legally be
        ...
        <section className="legal-section" aria-labelledby="changes-heading">
          ...
          <p>
            ...
            don&rsquo;t accept, cancel before the date and we&rsquo;ll
            refund the unused portion of any pre-paid period.
          </p>
        </section>
